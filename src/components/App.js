		...
		return (
			<div className={cx('container')}>
				<Helmet>
					...
					<meta name="og:image" content={`https://fallback-automation.now.sh/api?url=https%3A%2F%2Fwhatdoyousuggest.net%2F${encodeURIComponent(input2url(term))}&amp;selector=svg`}></meta>
